  ...
  <div class="card">
    ...
    <div class="card-body p-0">
      ...
      <div class="container-fluid mt-4">
        <h2 class="text-primary text-center mb-4">Nuestras especialidades</h2>
      ...
      <!-- SECCION DEL STAFF MEDICO -->

      <div class="card bg-purple ml-3 mr-3">
        <div class="card-header">
          <h3 class="card-title text-bold">STAFF MEDICO</h3>
        </div>
        <!-- /.card-header -->
      ...
      <div class="card bg-green " id="misionVison">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          Formar lideres en ciencias, ingeniería y arquitectura, dotados de competencias para la investigación, innovación y gestión tecnológicas, capaces de contribuir al bienestar de la sociedad, al desarrollo del país y a la afirmación de nuestra identidad nacional.
        </div>
      </div>

      <div class="card bg-green ">
        <div class="card-header">
          <h3 class="card-title text-bold">VISION</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          Ser la Clínica líder en la creación de ciencias y tecnología, comprometida con el desarrollo sostenible de la Nación.
        </div>
      </div>

      <!-- CENTRAL TELEFONICA -->
      <div class="card  central-telefonica">
